                ...
                <div className="login_container1">
                    ...
                    <form method="POST">
                        <div
                            className="uname1">
                            <h7>Username</h7>
                            <input type='email' value={uname} onChange={(e) => setUname(e.target.value)} placeholder="Email address" />
                        </div>
                        ...
                        <div
                            className="register_text1">
                            or Register as a <Link Link to="/customer-signup">Customer</Link> or a <Link Link to="/supplier-signup">Supplier</Link>.
                        </div>
                    </form>
                </div>
            </div>
