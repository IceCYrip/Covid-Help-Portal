...
function CAcc() {
    ...
    const editCustomerData = async () => {
        ...
        try {
            ...
            const res = await axios.put(`/api/customer/updatecustomer/${id}`,
                {
                    fname: first,
                    lname: last,
                    uname: email,
            ...
            <div className='bigcontainer'>
                <div className="left">
                    ...
                    <div className='fstepcacc1'>
                        <br></br>
                        <Link Link to="/customer" style={{ textDecoration: 'none' }}> <h8>Dashboard</h8></Link>
                        <br></br>
                        <br></br>
                    </div>
                ...
                <div className="rightaccounts">
                    <NormalField textleft={"First Name"} inputvalue={first} required="required" changefn={(e) => setFirst(e.target.value)} />
                    <br></br>
                    <NormalField textleft={"Last Name"} inputvalue={last} required="required" changefn={(e) => setLast(e.target.value)} />
                    <br></br>
                    <NumField textleft={"Contact"} inputvalue={contact} required="required" changefn={(e) => setContact(e.target.value)} />
                    <br></br>
                    <NormalField textleft={"Email"} inputvalue={email} required="required" changefn={(e) => setEmail(e.target.value)} inputting={true} />
                    <br></br>
