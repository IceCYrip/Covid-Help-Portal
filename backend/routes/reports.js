...
router.post("/userscount", async (req, res) => {
  try {
...
router.post("/customerperarea", async (req, res) => {
  try {
    ...
    let CPimpleSaudagar = (await Customer.where({ area: "Pimple Saudagar" }))
      .length;
...
router.post("/supplierperarea", async (req, res) => {
  try {
    ...
    let SPimpleSaudagar = (await Supplier.where({ area: "Pimple Saudagar" }))
      .length;
